...
**Ausgangslage:** In diesem Stand schlägt `./mvnw test` fehl. In der Überstunden-Berechnung aus Schritt 4 sind gezielt Fehler enthalten, die die Soll/Ist-Regel aus Schritt 4 verletzen (die Regel selbst steht unverändert im Javadoc von `OvertimeService` und in `CONTEXT.md`).
